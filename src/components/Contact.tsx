...
const socialLinks = [
  {
    label: "Email",
    href: "mailto:businessionew@gmail.com",
    icon: (
  ...
  {
    label: "GitHub",
    href: "https://github.com/ayoubley",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/ayoubbensadek",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl glass-card bg-transparent text-foreground placeholder-muted/50 focus:outline-none focus:border-foreground/30 transition-colors"
